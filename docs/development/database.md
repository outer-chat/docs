...
:::note
You can see a better version (not in markdown) of the database schema [here](https://github.com/outer-chat/outer-chat/blob/main/docs/data/database_schema.pdf).
:::
